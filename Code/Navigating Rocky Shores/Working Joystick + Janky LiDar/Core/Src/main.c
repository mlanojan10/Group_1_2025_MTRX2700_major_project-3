...
static uint16_t current_pan_pwm = 1500;  // initialize to center position
static uint16_t current_tilt_pwm = 1500;
const uint16_t step_size = 1;  // smaller step = slower movement
